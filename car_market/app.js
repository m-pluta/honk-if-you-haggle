...
app.get('/cars', function (req, resp) {
    const page_size = parseInt(req.query.size)    // How many items are displayed on each page
    const page = parseInt(req.query.page)         // Which page of items should be displayed
